...
export TG_BOT_TOKEN="5461332764:AAHJpn6nALBFpUnVMsUA5VTXjdNUWmv1PIg"
## 下方填写 @getuseridbot 中获取到的纯数字ID
export TG_USER_ID="1047773545"
## Telegram 代理IP（选填）
...
export GOTIFY_URL="http://42.192.149.83:8080"
export GOTIFY_TOKEN="lG0-9lzqu5W-"
